...
Call log:
  - waiting for locator('//button[@id=\'checkout_payment_btn\']')
    - locator resolved to <button disabled aria-busy="false" aria-disabled="true" id="checkout_payment_btn" sec_uuid_js:com.vodafone.travel.preprod.vrs="75aee86eac63" class="button__105qc7s2 button_baseButtonStyle__105qc7s1 button_reset__105qc7s0 button_button_appearance_primary__105qc7s5 button_button_fullWidth_true__105qc7s3 button_button_size_m__105qc7sb aurora_auroraTheme__16umceo0 ">…</button>
