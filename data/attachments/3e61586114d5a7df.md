...
Call log:
  ...
  - waiting for getByText('France', { exact: true }).first()
    ...
    6 × locator resolved to <h3>France</h3>
    ...
    - generic [ref=e233]:
      - list [ref=e234]:
        - listitem [ref=e235]:
          - list [ref=e236]:
            - listitem [ref=e237]:
              - button "Terms & Conditions" [ref=e238] [cursor=pointer]
              - separator [ref=e239]
            - listitem [ref=e240]:
            ...
            - listitem [ref=e243]:
              ...
              - separator [ref=e245]
            - listitem [ref=e246]:
              - button "Charges Guide" [ref=e247] [cursor=pointer]
              - separator [ref=e248]
            - listitem [ref=e249]:
              - button "Acceptable Usage Policy" [ref=e250] [cursor=pointer]
              - separator [ref=e251]
            - listitem [ref=e252]:
              - button "Ad Choices" [ref=e253] [cursor=pointer]
        - listitem [ref=e254]:
          - list [ref=e255]:
            - listitem [ref=e256]:
              - button "eSIM Installation Guide" [ref=e257] [cursor=pointer]
              - separator [ref=e258]
            - listitem [ref=e259]:
              - button "Help" [ref=e260] [cursor=pointer]
              - separator [ref=e261]
            - listitem [ref=e262]:
              - button "Contact us or Leave us" [ref=e263] [cursor=pointer]
      - paragraph [ref=e264]: "Vodafone Global Connect S.à r.l. is registered in the Grand Duchy of Luxembourg. R.C.S Luxembourg No. B144677. Registered Office: 15 rue Edward Steichen, L-2540 Luxembourg, Grand Duchy of Luxembourg. VAT LU29846245"
  - generic "TOBi chatbot over minimised" [ref=e265] [cursor=pointer]:
    - button "Click here to talk to tobi" [ref=e266]
    - generic [ref=e267]: Hi, I'm Tobi, your virtual agent. How can I help you today?
    - button "Minimise the TOBi floating area." [ref=e268]
  - generic [ref=e269] [cursor=pointer]:
    - button "Manage Cookies" [ref=e271]
    - text: Manage Cookies
```
