import { TestCase, CreatedTestCase, TestCycle } from './types.js';
...
export class ZephyrClient {
    ...
    async createTestCase(projectKey: string, testCase: TestCase, issueKey: string): Promise<CreatedTestCase> {
